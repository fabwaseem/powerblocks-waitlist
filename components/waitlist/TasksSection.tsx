      ...
      <div className="bg-gradient-to-b from-[#11042F] to-[#020106] lg:col-span-2 rounded-2xl border border-[#2a2a4e] p-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div>
              <Skeleton className="h-6 w-32 mb-4 bg-gray-700/50" />

              {/* Progress segments skeleton */}
            ...
            <div className="flex items-center gap-6">
              <Skeleton className="w-44 h-44 rounded-full bg-gray-700/50" />
          ...
          <div className="flex-1">
            <Skeleton className="h-6 w-16 mb-4 bg-gray-700/50" />
            <div className="flex flex-wrap justify-center gap-3 max-w-xs mx-auto lg:mx-0">
              {Array.from({ length: 25 }, (_, index) => (
                <Skeleton
                  key={index}
                  className="w-11 h-11 rounded-lg bg-gray-700/50"
                />
              ))}
            </div>
          </div>
